...
export function compose<T1, T2, T3>(func1: (t1: T1) => T2, func2: (t1: T2) => T3): (t1: T1) => T3;
export function compose<T1, T2, T3, T4>(func1: (t1: T1) => T2, func2: (t1: T2) => T3, func3: (t1: T3) => T4): (t1: T1) => T4;
export function compose<T1, T2, T3, T4, T5>(func1: (t1: T1) => T2, func2: (t1: T2) => T3, func3: (t1: T3) => T4,  func4: (t1: T4) => T5): (t1: T1) => T5;
